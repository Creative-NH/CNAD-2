...
func NewRouter() *mux.Router {
	...
	r.HandleFunc("/risks", middleware.AuthRequired(risksGetHandler)).Methods("GET")
	r.HandleFunc("/assessments", middleware.AuthRequired(assessmentsGetHandler)).Methods("GET")
...
func assessmentsGetHandler(w http.ResponseWriter, r *http.Request) {
	utils.ExecuteTemplate(w, "assessments.html", nil)
...
func risksGetHandler(w http.ResponseWriter, r *http.Request) {
	utils.ExecuteTemplate(w, "risks.html", nil)
